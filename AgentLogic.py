...
class IGBot:
    ...
    def unfollow_people(self, webdriver, people):
        print(
            "_______________________________________Start Unfollow sequence_________________________________________________________________")
        flag_max_unfollow = 0
    ...
    def like_on_home(self, webdriver):
        ...
        print(
            "_________________________________________________Start Like on home____________________________________________________")
        ...
        try:
            article = webdriver.find_element_by_xpath(
                self.article_four)  # find article 4 and like it in order to load next articles
        except:
            body.send_keys(Keys.DOWN)
            body.send_keys(Keys.DOWN)
            body.send_keys(Keys.DOWN)
        ...
        print(
            "______________________________________________Stop Like on home_________________________________________________________")
                ...
                for x in range(1, random_pick):
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                likes = int(
                                    webdriver.find_element_by_xpath(self.no_likes_xpath_second).text.replace(",", ""))
                            except:
    ...
    def getUserFollowers(self, webdriver, int_user):
        ...
        sleep(2)
        followersLink = webdriver.find_element_by_xpath(
